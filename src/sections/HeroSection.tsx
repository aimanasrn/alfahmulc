...
export function HeroSection() {
  ...
  return (
    <section
      className="relative overflow-hidden px-4 pb-20 pt-10 sm:px-6 sm:pb-24"
      id="home"
    >
      ...
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[minmax(0,1.2fr)_minmax(320px,0.8fr)] lg:items-center">
            ...
            <div className="relative space-y-8">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <h2 className="mt-2 text-2xl font-bold">{t("hero.panel.title")}</h2>
                </div>
